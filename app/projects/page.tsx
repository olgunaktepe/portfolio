            ...
            >
              ...
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-6">
                <div>
                  <span className={`inline-block px-3 py-1 rounded-full text-sm font-medium mb-3 ${
                    project.industry === 'web3'
                      ? 'bg-[var(--v3-burgundy)]/20 text-[var(--v3-burgundy-light)]'
                  ...
                  <p className="text-lg text-[var(--v3-burgundy-light)] font-medium">
                    {project.title}
                  </p>
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-[var(--v3-burgundy)] text-white rounded-lg font-medium hover:bg-[var(--v3-burgundy-light)] transition-colors shrink-0"
                >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6 pb-6 border-b border-[var(--v3-navy-700)]">
                {project.results.map((result, index) => (
                  <div key={index} className="text-center p-4 bg-[var(--v3-navy-800)] rounded-lg">
                    ...
                    <div className="text-xs text-[var(--v3-text-muted)] uppercase tracking-wider mt-1">
                      {result.label}
                    </div>
                  </div>
                ))}
              ...
              {/* Collateral Preview */}
              <div className="mb-6">
                <h3 className="text-sm font-semibold text-[var(--v3-text-muted)] uppercase tracking-wider mb-4">
                ...
                <div className="flex flex-wrap gap-3">
                  {project.collateral.slice(0, 6).map((item) => (
                    ...
                    >
                      {item.type === 'pdf' && <FileText size={14} className="text-[var(--v3-burgundy-light)]" />}
